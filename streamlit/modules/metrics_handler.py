    ...
    try:
        ...
        with psycopg2.connect(DB_CONNECTION_STRING) as conn:
            with conn.cursor() as cur:
                ...
                if (
                    "current_game_interaction" in st.session_state
                    and game_id in st.session_state.current_game_interaction
                ):
    ...
    try:
        ...
        with psycopg2.connect(DB_CONNECTION_STRING) as conn:
            with conn.cursor() as cur:
                ...
                """
                cur.execute(
                    query, (user_id, game_id, timestamp, prompt_length_role1, prompt_length_role2, prompt_edits)
                )
    ...
    try:
        ...
        with psycopg2.connect(DB_CONNECTION_STRING) as conn:
            with conn.cursor() as cur:
                ...
                """
                cur.execute(
                    query, (game_id, round_number, group1_id, group2_id, timestamp, deal_score_role1, deal_score_role2)
                )
...
def test_database_tables():
    ...
    try:
        ...
        return dict.fromkeys(tables, False)
    ...
    try:
        ...
        with psycopg2.connect(DB_CONNECTION_STRING) as conn:
            with conn.cursor() as cur:
                ...
                """
                cur.execute(query, (conversation_id, user_id, timestamp, total_exchanges, conversation_duration))
                return True
    except Exception as e:
    ...
    try:
        ...
        with psycopg2.connect(DB_CONNECTION_STRING) as conn:
            with conn.cursor() as cur:
                ...
                """
                cur.execute(query, (deal_id, user_id, timestamp, deal_value, negotiation_rounds, deal_success))
                return True
    except Exception as e:
